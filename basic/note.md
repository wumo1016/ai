...
- 简介
  - Harness: 马具(持续靠谱的干完整个任务)
  - 图解: <img src="./images/harness.webp" />
    - 上下文架构
      - 让 AI 了解项目的所有上下文, 比如: 需求, 规范
    - 执行能力
      - 给 AI 装上手脚和工具, 工具调用、mcp、skills、cli
    - 任务编排
      - 需求拆分, 任务分配
    - 反馈机制
      - 让 AI 自我检查, 跑 Linter(语法规范), 跑自动化测试, 自己打开浏览器操作一遍
    - 架构护栏
      - 系统规则: 如 模块间必须单向依赖
      - pre-commit 钩子: 检查代码是否符合规范

## 剃刀定律(法则)(奥卡姆剃刀/Occam's Razor)

- 核心思想
  - 如无必要，勿增实体
  - 如果有多个解释，优先选择最简单、假设最少的那个
  - 在证据不足的时候，优先相信最简单的解释

- 适合角色: 模型设计、特征筛选、异常排查
- 例子
  - <img src="./images/剃刀定律1.png" />
  - <img src="./images/剃刀定律2.png" />

## 墨菲定律(法则)(KISS Principle)

- 核心思想
  - 凡是有可能出错的事情，最终都会出错，不管可能性有多小
  - 假设一切都会出错，做好兜底和防御。
- 适合角色: 测试/安全工程师
- 例如: 超时重试、熔断、默认值、容错都是墨菲定律思想

## 贝叶斯公式(法则)(Bayes' Theorem)

- 核心思想: 根据新的证据，不断修正自己的判断
- 适合角色: 算法/数学基础
- 例如
  - <img src="./images/贝叶斯公式.png" />
